...
@pytest.fixture
def complete_account(account_id: int, basic_account: Account) -> Account:
    return Account.model_validate(basic_account.model_dump(), update={"account_id": account_id})
...
class TestGetAll:
    ...
    @pytest.fixture
    def expected_multiple_accounts(self, complete_account: Account) -> list[AccountRead]:
        working_account = AccountRead.model_validate(complete_account)
    ...
    async def test_get_all(
        self, user: User, mock_db: Mock, expected_sql: str, expected_response: list[AccountRead]
    ) -> None:
...
class TestCreate:
    ...
    async def test_create_with_portfolio_found(
        ...
        expected_add_params = [complete_account.model_dump(), initial_transaction.model_dump()]
    ...
    async def test_create_with_portfolio_not_found(
        self, user: User, account_to_create: AccountCreate, mock_db: Mock, expected_sql: str
    ) -> None:
...
class TestGet:
    @pytest.fixture
    def expected_response(self, complete_account: Account) -> AccountRead:
        return AccountRead.model_validate(complete_account)
    ...
    async def test_get_with_data(
        self, user: User, account_id: int, mock_db: Mock, expected_sql: str, expected_response: AccountRead
    ) -> None:
...
class TestUpdate:
    @pytest.fixture
    def account_updates(self) -> AccountUpdate:
    ...
    @pytest.fixture
    def expected_response(self, updated_account: Account) -> AccountRead:
        return AccountRead.model_validate(updated_account.model_dump())
