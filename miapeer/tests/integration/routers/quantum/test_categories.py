...
class TestCreate:
    def test_create_category(
        self, client: TestClient, my_portfolio: Portfolio, not_my_category_2: Category
    ) -> None:
...
@pytest.mark.usefixtures("create_complete_portfolio")
class TestGetOne:
    def test_get_one_category_in_portfolio_succeeds(
        self, client: TestClient, my_category_1: Category
    ) -> None:
    ...
    def test_get_one_category_in_wrong_portfolio_fails(
        self, client: TestClient, not_my_category_1: Category
    ) -> None:
    ...
    @pytest.mark.parametrize(
        "category_id", [0, -1, 999999999999999999, -999999999999999999]
    )
    def test_get_one_category_with_invalid_category_id_fails(
        self, client: TestClient, category_id: int
    ) -> None:
...
class TestUpdate:
    ...
    def test_update_category_in_wrong_portfolio_fails(
        self, client: TestClient, not_my_category_1: Category
    ) -> None:
        response = client.patch(
    ...
    def test_update_category_with_invalid_category_id_fails(
        self, client: TestClient, category_id: int
    ) -> None:
        response = client.patch(
            f"/quantum/v1/categories/{category_id}", json={"name": "Coffee"}
        )
...
class TestDelete:
    ...
    def test_delete_category_in_wrong_portfolio_fails(
        self, client: TestClient, not_my_category_1: Category
    ) -> None:
        response = client.delete(
            f"/quantum/v1/categories/{not_my_category_1.category_id}",
    ...
    def test_delete_category_with_invalid_category_id_fails(
        self, client: TestClient, category_id: int
    ) -> None:
